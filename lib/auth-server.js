...
import { getDb, runQuery, getQuery } from './db';
...
export async function createUser(username, password) {
  ...
  try {
    ...
    const existingUser = await db.get(checkUserSQL, [username]);
    ...
    const result = await db.run(insertUserSQL, [username, hashedPassword]);
